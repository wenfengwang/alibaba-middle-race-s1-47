...
public class Producer {
    ...
    public static volatile int countNum = 1;
    /**
            ...
            try {
                ...
                for (final PaymentMessage paymentMessage : paymentMessages) {
                    ...
                    if (retVal > 0) {
                        ...
                        final Message messageToBroker = new Message(RaceConfig.MqPayTopic, "Test", RaceUtils.writeKryoObject(paymentMessage));
